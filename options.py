...
def get_arg_parser():
    ...
    parser.add_argument('--video_root', type=str, default=r'E:\dataset\GRID\lips')
    parser.add_argument('--align_root', type=str, default=r'E:\dataset\GRID\align')

    # --load 接pt模型路径，是在推断时使用
